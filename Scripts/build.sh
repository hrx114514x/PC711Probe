...
bundle_dir="$build_dir/PC711Probe.kext"
...
common_defines="-DKERNEL -DKERNEL_PRIVATE -D__KERNEL__ -DPRODUCT_NAME=PC711Probe -DMODULE_VERSION=0.6.0 -DMACH_ASSERT=1"
