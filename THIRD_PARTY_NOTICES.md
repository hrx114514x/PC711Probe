...
PC711Probe uses the following source dependencies as pinned Git submodules:

- **Lilu** — <https://github.com/acidanthera/Lilu>
  Copyright (c) vit9696 and contributors. Licensed under the BSD 3-Clause license included in the submodule.
